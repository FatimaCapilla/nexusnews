...
exports.validateDeleteNews = exports.validateUpdateNews = exports.validateCreateNews = void 0;
var express_validator_1 = require("express-validator");
var validateHelper_1 = require("../helpers/validateHelper");
var NewsModel_1 = require("../Models/NewsModel");
...
exports.validateDeleteNews = [
    (0, express_validator_1.check)('id')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, NewsModel_1.default.findByPk(id)];
                case 1:
                    news = _a.sent();
                    if (!news) {
